...
def _extract_mnist_data():
    ...
    mnist_obj = s3hook.get_key(bucket_name="mnistbucket", key="mnist.pkl.gz")
    ...
    with gzip.GzipFile(fileobj=mnist_buffer, mode="rb") as f:
        ...
        s3hook.load_file_obj(
            output_buffer, key="mnist_data", bucket_name="mnistbucket", replace=True
        )
        ...
        "InputDataConfig": [
            {
                ...
                "DataSource": {
                    "S3DataSource": {
                        "S3DataType": "S3Prefix",
                        "S3Uri": "s3://mnistbucket/mnist_data",
                        "S3DataDistributionType": "FullyReplicated",
                    }
                },
            }
        ],
        "OutputDataConfig": {"S3OutputPath": "s3://mnistbucket/mnistclassifier-output"},
        "ResourceConfig": {
